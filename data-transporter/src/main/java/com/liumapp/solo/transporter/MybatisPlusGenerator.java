...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/solo?serverTimezone=GMT%2B8&useUnicode=true&useSSL=false&characterEncoding=utf8");
         dsc.setSchemaName("solo");
        ...
        pc.setModuleName("db");
        pc.setParent("com.liumapp.solo.transporter");
